...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'inline-flex h-12 items-center justify-center gap-1 rounded-xl bg-gray-100 p-1',
        className
      )}
      {...props}
    />
